...
1. **Competitor Matrix**
   - Direct competitors: Cursor, Windsurf, Replit, GitHub Copilot Workspace
   - Indirect competitors: Bolt, Lovable, v0, traditional IDEs
...
3. **Market Trends**
   ...
   - Emerging categories (agentic IDE, multi-agent orchestration)

4. **SWOT Analysis (Fabrica)**
   - Strengths: Parallel worktrees, agent orchestration, approval gates
   - Weaknesses: New entrant, unknown brand
   - Opportunities: Founder-focused positioning, "exit" narrative
   - Threats: Incumbent funding, platform lock-in
...
1. **Positioning Statement**
   - For [founders/builders] who [need to ship fast with AI]
   - Fabrica is the [agentic IDE] that [orchestrates parallel agents with approval gates]
...
3. **Messaging Hierarchy**
   - Primary message: "The Next AI Exit"
   - Supporting messages: builder-first, parallel agents, approval gates
